            ...
            <main className="text-white max-w-[1440px] mx-auto mt-[160px] p-5">
                ...
                <section className="py-14 flex flex-col md:flex-row gap-4 md:items-start ">
                    ...
                    <article className="w-full md:w-1/2 lg:w-2/3">
                        ...
                        <p className="mt-2 text-lg">
                            Chez <span className="text-yellow-02 italic font-bold underline underline-offset-2 decoration-red-02">Garage V. Parrot</span>, nous croyons que
                            l&apos;automobile est bien plus qu&apos;un simple
                            moyen de transport. C&apos;est une passion, une
                            extension de votre vie, et un symbole de liberté.
                            Notre mission est de vous aider à entretenir,
                            réparer et améliorer votre véhicule pour qu&apos;il
                            soit à la hauteur de vos rêves et de vos ambitions.
                        </p>
                    </article>
                </section>
                <section className="py-14 flex flex-col md:flex-row-reverse gap-4 md:items-start ">
                    ...
                    <article className="w-full md:w-1/2 lg:w-2/3">
                        ...
                        <p className="mt-2 text-lg">
                            Notre garage est bien plus qu&apos;un endroit où l&apos;on
                            répare des voitures. C&apos;est un lieu où les moteurs
                            chantent, où les problèmes sont résolus, et où les
                            rêves prennent forme. Que vous ayez besoin de notre
                            service de mécanique pour redonner vie à votre
                            bolide ou de notre service de carrosserie pour lui
                            rendre sa splendeur d&apos;antan, nous sommes là pour
                            répondre à vos besoins avec expertise et passion.
                        </p>
                    </article>
                </section>
                <section className="py-14 flex flex-col md:flex-row gap-4 md:items-start ">
                    ...
                    <article className="w-full md:w-1/2 lg:w-2/3">
                        ...
                        <p className="mt-2 text-lg">
                            ...
                            carrosserie est composée de passionnés de
                            l&apos;automobile. Chacun d&apos;entre nous est fier de son
                            rôle dans la préservation et l&apos;amélioration de ces
                            machines incroyables que sont les voitures. Nous
                            nous engageons à fournir des services de la plus
                            haute qualité, en utilisant les technologies les
                            plus avancées et les meilleures pratiques de
                            l&apos;industrie.
                        </p>
                    </article>
                </section>
                <section className="py-14 flex flex-col md:flex-row-reverse gap-4 md:items-start ">
                    ...
                    <article className="w-full md:w-1/2 lg:w-2/3">
                        ...
                        <p className="mt-2 text-lg">
                            Chez <span className="text-yellow-02 italic font-bold underline underline-offset-2 decoration-red-02">Garage V. Parrot</span>, votre satisfaction est
                            ...
                            chaque visite. Notre approche personnalisée signifie
                            que nous prenons le temps de vous écouter, de
                            comprendre vos besoins et de vous conseiller sur les
                            meilleures solutions pour votre véhicule.
                        </p>
                    </article>
                </section>
                <section className="py-14 flex flex-col md:flex-row gap-4 md:items-start ">
                ...
                <section className="py-14 flex flex-col md:flex-row-reverse gap-4 md:items-start ">
                    ...
                    <article className="w-full md:w-1/2 lg:w-2/3">
                        ...
                        <p className="mt-2 text-lg">
                            ...
                            recherche d&apos;un service de confiance pour votre
                            véhicule, <span className="text-yellow-02 font-bold underline underline-offset-2 italic decoration-red-02">Garage V. Parrot</span> est là pour vous.
                            Découvrez nos services de mécanique et de
                            carrosserie de classe mondiale et prenez le contrôle
                            de votre expérience automobile. <br /><br /> Merci de nous faire
                            confiance pour prendre soin de votre précieux moyen
                            de transport. Chez <span className="text-yellow-02 italic font-bold underline underline-offset-2 decoration-red-02">Garage V. Parrot</span>,
                            l&apos;automobile est bien plus qu&apos;un métier, c&apos;est une
                            passion que nous partageons avec vous.
                        </p>
                    </article>
                </section>
            </main>
