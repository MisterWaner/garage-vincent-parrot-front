...
const Testimonial = ({review, author}) => {
    return (
        <>
            {/*      <!-- Component: Elevated base sized testimonial with rating stars --> */}
            <div className="overflow-hidden rounded bg-red-02 text-black-02 my-4">
                <div className="relative p-6">
                    <figure className="relative z-10">
                        ...
                        <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm">
                            ...
                            <div className="flex items-center gap-4 pt-4 text-sm text-yellow-02">
